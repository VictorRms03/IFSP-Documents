...
public class TernaryMaxPriorityQueue<Key extends Comparable<Key>> implements PriorityQueue<Key> {
    ...
    private void sink( int k ) {
        ...
        while(3*k-1 <= this.getSize()){
            ...
            } else if (j < this.getSize() && !less(j+1, j)){
                j = j+1;
            }
    ...
    /**
     * 
     * @param i posição do Heap
     * @param j posição do Heap
     * @return Retorna verdadeiro se i < j
     */
