...
public class ElsifPart extends AST {
    ...
    /**
     * Construct an elsif part with the specified boolean expression and list of
     * "then" statements.
     *
     * @param booleanExpr the boolean expression that, if true, will result in
     * the execution of the list of "then" statements.
    ...
    /**
     * Set the label associated with the end of the if statement (used for code
     * generation.)
     */
    ...
    public Expression getBooleanExpr() {
        return booleanExpr;
    }
