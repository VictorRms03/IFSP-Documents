...
public abstract class Expression extends AST {
    ...
    private Position exprPosition;   // position of the expression
    ...
    /**
     * Construct an expression with the specified position. Initializes the type
     * of the expression to UNKNOWN.
     */
    ...
    public Position getExprPosition() {
        return exprPosition;
    }
