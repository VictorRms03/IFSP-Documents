...
public abstract class SubprogramDecl extends Declaration {
    ...
    /**
     * Construct a subprogram declaration with the specified subprogram
     * identifier.
     */
    ...
    /**
     * Set the relative address (offset) for each variable and parameter, and
     * compute the length of all variables.
     */
