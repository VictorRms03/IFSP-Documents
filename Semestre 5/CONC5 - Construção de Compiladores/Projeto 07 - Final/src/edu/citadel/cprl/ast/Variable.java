...
public class Variable extends Expression {
    ...
    public void emit() throws CodeGenException {
        ...
        for ( Expression expr : indexExprs ) {
            ...
            // emite código para computar o valor do índice
            expr.emit();

            // multiplicando pelo tamanho do tipo elemento do array para obter
            // o offset
            ...
            // Nota: não há código que verifica os limites do índice do array
            // para ter certeza que o índice é maior ou igual a 0 e menor que
            // número de elementos.

            // adiciona o offset ao endereço base
            emit( "ADD" );
