...
public class DFA {
     ...
     * destino não existirem e se já houver uma transição com o mesmo símbolo
     * no estado de origem.
     */
    ...
    public boolean accepts( String string ) throws IllegalStateException {
        ...
        //Variavel que irá acompanhar em qual 'State' o programa se encontra
        State actualState = startingState;
        ...
        for(int i=0; i<string.length(); i++){
            ...
            //Percorre cada transição do 'actualState' e verifica se existe alguma transição possível
            for(Transition t : actualState.transitions){
                
                if(t.symbol == string.charAt(i)){
                    actualState = t.target;
