 ...
 * @author victo
 */
@WebServlet(name = "formularioProdutoServlet", urlPatterns = {"/formularioProduto"})
public class formularioProdutoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String qntdEmbalagem = request.getParameter( "qntdEmbalagem" );
        String fabricante = request.getParameter( "fabricante" );
        
        System.out.println( "Código de Barras: " + codBarras );
        System.out.println( "Descrição: " + descricao );
        System.out.println( "Unidade de Medida: " + unidadeMedida );
        System.out.println( "Quantidade de Embalagens: " + qntdEmbalagem );
